# member6 — MC-OCR / validation

Gói này có **195 ảnh**. Dataset và split được giữ cố định, không chuyển ảnh sang gói khác.
Đường dẫn từ repository: `task/member6/MC-OCR/validation/`.
