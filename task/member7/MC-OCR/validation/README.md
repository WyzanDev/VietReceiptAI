# member7 — MC-OCR / validation

Gói này có **194 ảnh**. Dataset và split được giữ cố định, không chuyển ảnh sang gói khác.
Đường dẫn từ repository: `task/member7/MC-OCR/validation/`.
