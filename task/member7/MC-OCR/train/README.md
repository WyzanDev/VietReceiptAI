# member7 — MC-OCR / train

Gói này có **137 ảnh**. Dataset và split được giữ cố định, không chuyển ảnh sang gói khác.
Đường dẫn từ repository: `task/member7/MC-OCR/train/`.
