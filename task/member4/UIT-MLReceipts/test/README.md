# member4 — UIT-MLReceipts / test

Gói này có **395 ảnh**. Dataset và split được giữ cố định, không chuyển ảnh sang gói khác.
Đường dẫn từ repository: `task/member4/UIT-MLReceipts/test/`.
