# member3 — UIT-MLReceipts / val

Gói này có **358 ảnh**. Dataset và split được giữ cố định, không chuyển ảnh sang gói khác.
Đường dẫn từ repository: `task/member3/UIT-MLReceipts/val/`.
