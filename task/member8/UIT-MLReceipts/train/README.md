# member8 — UIT-MLReceipts / train

Gói này có **249 ảnh**. Dataset và split được giữ cố định, không chuyển ảnh sang gói khác.
Đường dẫn từ repository: `task/member8/UIT-MLReceipts/train/`.
