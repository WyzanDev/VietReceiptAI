# member1 — UIT-MLReceipts / train

Gói này có **373 ảnh**. Dataset và split được giữ cố định, không chuyển ảnh sang gói khác.
Đường dẫn từ repository: `task/member1/UIT-MLReceipts/train/`.
