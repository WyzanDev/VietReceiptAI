# member5 — UIT-MLReceipts / test

Gói này có **394 ảnh**. Dataset và split được giữ cố định, không chuyển ảnh sang gói khác.
Đường dẫn từ repository: `task/member5/UIT-MLReceipts/test/`.
